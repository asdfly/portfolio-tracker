...
def test_tab10_empty():
    from tabs.tab10_fund_flow import render_tab10; render_tab10(_empty_df(),_empty_df(),_empty_df(),**KW)
def test_tab11_empty():
    from tabs.tab11_gold import render_tab11; render_tab11(_empty_df(),_empty_df(),_empty_df(),**KW)

# 正常数据 5个关键Tab
def test_tab1_normal():
    from tabs.tab1_net_value import render_tab1; render_tab1(_sample_pos(),_sample_sum(),_sample_idx(),**KW)
def test_tab2_normal():
    from tabs.tab2_position import render_tab2; render_tab2(_sample_pos(),_sample_sum(),_sample_idx(),**KW)
def test_tab3_normal():
    from tabs.tab3_risk import render_tab3; render_tab3(_sample_pos(),_sample_sum(),_sample_idx(),**KW)
def test_tab5_normal():
    from tabs.tab5_advanced import render_tab5; render_tab5(_sample_pos(),_sample_sum(),_sample_idx(),**KW)
def test_tab7_normal():
    from tabs.tab7_news import render_tab7; render_tab7(_sample_pos(),_sample_sum(),_sample_idx(),**KW)

# 部分数据边界
def test_tab3_summary_one_row():
    from tabs.tab3_risk import render_tab3; render_tab3(_sample_pos(),_sample_sum(n=1),_empty_df(),**KW)
def test_tab6_no_technical():
    from tabs.tab6_technical import render_tab6; render_tab6(_sample_pos(),_sample_sum(),_empty_df(),**KW)
def test_tab8_empty_advice():
    from tabs.tab8_advice import render_tab8; render_tab8(_sample_pos(),_sample_sum(n=5),_empty_df(),**KW)
def test_tab9_empty_custom():
    from tabs.tab9_custom import render_tab9; render_tab9(_sample_pos(),_sample_sum(n=5),_empty_df(),**KW)
def test_tab10_empty_flow():
    from tabs.tab10_fund_flow import render_tab10; render_tab10(_sample_pos(),_sample_sum(n=5),_empty_df(),**KW)